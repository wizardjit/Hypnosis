...
local drawing  = loadstring(request({Url = 'https://raw.githubusercontent.com/dementiaenjoyer/UI-LIBRARIES/refs/heads/main/idk_what_this_is/extensions/drawing.lua', Method = 'GET'}).Body)()
local tween = loadstring(request({Url = 'https://raw.githubusercontent.com/dementiaenjoyer/UI-LIBRARIES/refs/heads/main/idk_what_this_is/extensions/tween.lua', Method = 'GET'}).Body)()
...
local themes = { -- ignore
    ["Default"] = {
        ...
        ["Risky Text"] = Color3.fromRGB(255, 0, 0);
